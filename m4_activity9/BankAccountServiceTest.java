...
public class BankAccountServiceTest {
	...
	public static void main(String[] args) {
		...
		// Happy Path
		testCase(() -> service.createAccount("ACC001", "John Doe", 10000.0),
				"Create account ACC001 with initial balance 10000");
		testCase(() -> service.createAccount("ACC002", "Jane Smith", 5000.0),
				"Create account ACC002 with initial balance 5000");
		...
		testCase(() -> service.createAccount("ACC004", "Charlie Wilson", -1000.0),
