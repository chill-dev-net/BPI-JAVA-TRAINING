...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (initialBalance < MINIMUM_INITIAL_BALANCE) {
			...
			throw new InvalidAccountException(String.format("[MINIMUM_INITIAL_BALANCE=%s, initialBalance=%s]",
	...
	public void transfer(String fromAccountNumber, String toAccountNumber, double amount)
		...
		if (amount <= 0) {
			...
			// Parameter: amount
			logger.info("Transfer failed: invalid amount {}", amount);
		...
		if (fromAccountNumber.equals(toAccountNumber)) {
			...
			throw new InvalidTransferException(
					String.format("Cannot transfer from account %s to itself", fromAccountNumber));
		...
		if (fromAccount == null) {
			...
			throw new AccountNotFoundException(String.format("Source account not found: %s", fromAccountNumber));
		}
		...
		if (toAccount == null) {
			...
			throw new AccountNotFoundException(String.format("Destination account not found: %s", toAccountNumber));
		}
		...
		if (fromAccount.getBalance() < amount) {
			...
			throw new InsufficientFundsException(
					String.format("Balance: %s, required amount: %s", fromAccount.getBalance(), amount));
